...
define print_intf_references
   set $__intf = (Interface *)((size_t)($Xnode) - 0x10))
...
define vrf_assign_entry_match
    set $__va = (VrfAssign *)((size_t)($Xnode) - 0x10))
...
define mirror_entry_match
    set $__mirror = (MirrorEntry *)((size_t)($Xnode) - 0x10))

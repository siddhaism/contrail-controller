...
class ErmVpnCMcastTest : public ErmVpnTableTest {
};

TEST_F(ErmVpnCMcastTest, AddDeleteSingleRoute) {
    ostringstream repr;
...
// Prefixes differ only in the IP address field of the RD.
TEST_F(ErmVpnCMcastTest, AddDeleteMultipleRoute1) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
// Prefixes differ only in the group field.
TEST_F(ErmVpnCMcastTest, AddDeleteMultipleRoute2) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
// Prefixes differ only in the source field.
TEST_F(ErmVpnCMcastTest, AddDeleteMultipleRoute3) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
TEST_F(ErmVpnCMcastTest, AddDeleteMultipleRoute4) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
TEST_F(ErmVpnCMcastTest, Hashing) {
    for (int idx = 1; idx <= 255; idx++) {
        ostringstream repr;
        repr << "1-10.1.1.1:65535-20.1.1.1,224.168.1." << idx << ",192.168.1.1";
        AddRoute(blue_, repr.str());
...
TEST_F(ErmVpnCMcastTest, ReplicateRouteFromVPN1) {
...
TEST_F(ErmVpnCMcastTest, RouteReplicateFromVPN2) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr1;
...
TEST_F(ErmVpnCMcastTest, RouteReplicateFromVPN3) {
    ostringstream repr2;
...
class ErmVpnTreeTest : public ErmVpnTableTest {
};

TEST_F(ErmVpnTreeTest, AddDeleteSingleRoute) {
    ostringstream repr;
...
// Prefixes differ only in the IP address field of the RD.
TEST_F(ErmVpnTreeTest, AddDeleteMultipleRoute1) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
// Prefixes differ only in the group field.
TEST_F(ErmVpnTreeTest, AddDeleteMultipleRoute2) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
// Prefixes differ only in the source field.
TEST_F(ErmVpnTreeTest, AddDeleteMultipleRoute3) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
// Prefixes differ only in the router-id field.
TEST_F(ErmVpnTreeTest, AddDeleteMultipleRoute4) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr;
...
TEST_F(ErmVpnTreeTest, ReplicateRouteToVPN1) {
    ostringstream repr1, repr2;
...
TEST_F(ErmVpnTreeTest, RouteReplicateToVPN2) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr1;
...
TEST_F(ErmVpnTreeTest, ReplicateRouteFromVPN1) {
    ostringstream repr1, repr2;
...
TEST_F(ErmVpnTreeTest, RouteReplicateFromVPN2) {
    for (int idx = 1; idx <= kRouteCount; idx++) {
        ostringstream repr1;
...
TEST_F(ErmVpnTreeTest, RouteReplicateFromVPN3) {
    ostringstream repr2;
